...
from . import (
    tensor_shape_pb2 as tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2.DESCRIPTOR,
        tensorflow_dot_core_dot_framework_dot_types__pb2.DESCRIPTOR,
    ],
)
...
_RESOURCEHANDLEPROTO_DTYPEANDSHAPE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="dtype",
            full_name="tensorflow.ResourceHandleProto.DtypeAndShape.dtype",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="shape",
            full_name="tensorflow.ResourceHandleProto.DtypeAndShape.shape",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_RESOURCEHANDLEPROTO = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="dtypes_and_shapes",
            full_name="tensorflow.ResourceHandleProto.dtypes_and_shapes",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="tensorflow.ResourceHandleProto.allowed_devices",
            index=6,
            number=7,
            type=9,
            cpp_type=9,
...
_RESOURCEHANDLEPROTO_DTYPEANDSHAPE.fields_by_name[
    "dtype"
].enum_type = tensorflow_dot_core_dot_framework_dot_types__pb2._DATATYPE
_RESOURCEHANDLEPROTO_DTYPEANDSHAPE.fields_by_name[
    "shape"
].message_type = (
    tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2._TENSORSHAPEPROTO
)
_RESOURCEHANDLEPROTO_DTYPEANDSHAPE.containing_type = _RESOURCEHANDLEPROTO
_RESOURCEHANDLEPROTO.fields_by_name[
    "dtypes_and_shapes"
].message_type = _RESOURCEHANDLEPROTO_DTYPEANDSHAPE
...
ResourceHandleProto = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "DtypeAndShape": _reflection.GeneratedProtocolMessageType(
            "DtypeAndShape",
            (_message.Message,),
            {
